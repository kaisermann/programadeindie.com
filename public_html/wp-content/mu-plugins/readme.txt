...
* Low requests on the front and back end to track how well certain pages and templates perform
...
= 0.2.2 =
* Resolved issues with Windows file paths which caused data to not be logged and the warning about running as an MU plugin even when it is
