		...
		uglify:
		{
			my_target:
			{
				files:
				{
					...
					,
					'assets/js/admin/admin.min.js': ['assets/js/admin/*.js', 'assets/js/admin/core.js', '!assets/js/admin/admin.min.js']
					,
					'assets/js/lugares/lugares.min.js': ['assets/js/lugares/core.js', 'assets/js/lugares/*.js', '!assets/js/lugares/lugares.min.js']
				}
			}
		},
		watch:
